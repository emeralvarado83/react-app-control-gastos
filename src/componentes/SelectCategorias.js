...
const SelectCategorias = ({opcion, cambiarOpcion}) => {
    const [mostrarCategoria, cambiarMostrarCategoria] = useState(false);
    ...
    const handleOpcion = (e) => {
        ...
        cambiarMostrarCategoria(false);
    }

    return (
        <ContenedorSelect>
            <OpcionSeleccionada onClick={() => cambiarMostrarCategoria(!mostrarCategoria)}>
                {opcion} <IconoDown/>
            </OpcionSeleccionada>
            {mostrarCategoria && 
            <Opciones>
